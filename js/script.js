...
function changeLanguage() {
    ...
    if (language === "french") {
        questionHeading.textContent = "Seras-tu mon amour pour toujours?";
              ...
              questionHeading.textContent = "Wirst Du für immer meine Liebe sein?";
    } else {
    ...
    if (language === "french") {
        successMessage.textContent = "Yepppie 💘, Je t'aime ma chérie 😘";
              ...
              successMessage.textContent = "Jaaaa 💘, Ich liebe Dich mein Liebling 😘";
    } else {
        successMessage.textContent = "Yepppie 💘, I Love You my darling 😘";
    }
}